...
const services = [
  ...
  },
  {
    ...
    description:
      'Immersive walkthroughs that let owners and contractors walk through the building before it is built. VR, web-based viewers, and HoloLens AR overlays from your Revit models.',
    bg: 'bg-ink-600',
    text: 'text-white',
